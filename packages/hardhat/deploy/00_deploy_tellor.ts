...
/**
 * Deploys a contract named "PriceContract" using the deployer account and
 * constructor arguments set to the deployer address
 *
 * @param hre HardhatRuntimeEnvironment object.
 */
const deployPriceContract: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  /*
  ...
  */
  ...
  // const tx = await PriceContract.setBtcPrice();
  // await tx.wait;
};

export default deployPriceContract;

// Tags are useful if you have multiple deploy files and only want to run one of them.
// e.g. yarn deploy --tags PriceContract
deployPriceContract.tags = ["PriceContract"];
